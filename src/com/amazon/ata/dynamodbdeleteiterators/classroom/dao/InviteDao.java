...
public class InviteDao {
    ...
    public boolean deleteInvite(String eventId, String memberId) {
        /*Invite invite = mapper.load(Invite.class, eventId, memberId);
        if (Objects.isNull(invite) || invite.isCanceled()) {
            return false;
        }
        ...
        expectedAttributeValueMap.put("isAttending", new ExpectedAttributeValue().withValue(new AttributeValue().withBOOL(false)));
        ...
        // Add additional safety checks and conditional deletes as needed.
